...
ActiveRecord::Schema.define(version: 20160716213123) do
  ...
  add_index "flyers", ["email"], name: "index_flyers_on_email", unique: true, using: :btree
  add_index "flyers", ["reset_password_token"], name: "index_flyers_on_reset_password_token", unique: true, using: :btree
  add_index "flyers", ["role_id"], name: "index_flyers_on_role_id", using: :btree
